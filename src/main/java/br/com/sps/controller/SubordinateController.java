...
public class SubordinateController {
	...
	responses = {
			@ApiResponse(description = "Sucess", responseCode = "200",
					content = {@Content(
							mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = Subordinate.class))
							)
			}),
	...
	public Subordinate getSubordinate(@PathVariable("id") Long id) {
	...
	public Subordinate createSubordinate(@RequestBody Subordinate vo){
	...
	public Subordinate updateSubordinate(@RequestBody Subordinate vo){
