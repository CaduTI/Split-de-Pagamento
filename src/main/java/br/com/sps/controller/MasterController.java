...
public class MasterController {
	...
	responses = {
			@ApiResponse(description = "Sucess", responseCode = "200",
					content = {@Content(
							mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = MasterVO.class))
							)
			}),
	...
	public MasterVO getMaster(@PathVariable("id") Long id) {
	...
	public MasterVO createMaster(@RequestBody MasterVO vo) {
	...
	public MasterVO updateMaster(@RequestBody MasterVO vo) {
