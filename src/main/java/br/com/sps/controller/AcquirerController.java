...
@RestController
@RequestMapping("api/acquirer/vi")
public class AcquirerController {
	...
	responses = {
			@ApiResponse(description = "Sucess", responseCode = "200",
					content = {@Content(
							mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = AcquirerVO.class))
							)
			}),
	...
	public AcquirerVO getAcquirer(@PathVariable("id") Long id) {
	...
	public AcquirerVO createAcquirer(@RequestBody AcquirerVO vo) {
	...
	public AcquirerVO updateAcquirer(@RequestBody AcquirerVO vo) {
